...
1층엔 버스킹 라운지, 숙직실, 행정실, 교장실, 체육실, 방송실, 보건실, 인쇄실, wee클래스, 기술실, 급식실 등이 있다. 버스킹 라운지는 문을 열자마자 있고. 숙직, 행정, 교장, 체육, 방송, 보건, 인쇄실은 들어와서 왼쪽길이야. 숙직실이 제일 첫번째로 있고 옆으로 순서대로 행정실, 교장실, 체육실, 방송실, 보건실이 있고 인쇄실은 체육실 교장실 맞은편에 있어. wee클래스와 기술실은 들어가고 앞으로 쭉 가면 둘다 있어. 앞으로 쭉 간다음에 왼쪽으로 꺾으면 급식실이 있어.
2층엔 스터디라운지 1, 교무실, 도서관, 정보실, 멀티미디어실, 1-1, 1-2, 1학년 교무실, 기술수업실, 진로실, 1-3, 1-4반이 있어. 중앙계단으로 올라가서 오른쪽으로 꺾으면 순서대로 스터디라운지1, 교무실 그리고 오른쪽 거의 끝으로 가서 왼쪽으로 꺾으면 순서대로 멀티미디어실, 정보실, 도서관이 있어. 다시 돌아가서 중앙계단 기준으로 왼쪽으로 2번 꺾으면 순서대로 1-1반 1-2반이 있어. 그리고 왼쪽으로 한번 더 꺾으면 순서대로 1학년 교무실, 기술수업실, 진로실, 1-3반 1-4반이 있어.
3층엔 2학년 교무실, 스터디라운지 2, 2-4, 2-3, 2-2, 2-1반, 강당, 과학준비실, 과학실1, 영어실3, 등등 있어 더 있긴 한데 나중에 업데이트 예정이야. 중앙계단 기준으로 올라오자마자 스터디라운지 2가 있고 왼쪽엔 2학년 교무실, 2-4, 2-3, 2-2, 2-1반이 있어, 왼쪽 거의 끝으로 가서 왼쪽으로 꺾으면 강당이 있어. 다시 돌아가서 중앙계단 기준으로 왼쪽으로 2번 꺾으면 과학준비실과 과학실1, 영어실 3이 있어 한번 그리고 왼쪽으로 한번 더 꺾으면 더 많은 교실이 있는데 나중에 업데이트 예정이야.
4층엔 3학년 교무실, 3-4, 3-3, 3-2, 3-1반이 있어 나중에 더 업데이트 예정이야. 중앙계단기준 바로앞에 3-4반이 있고 왼쪽엔 3학년교무실 오른쪽으로 순서대로 3-4 3-3 3-2 3-1반이 있어.
5층엔 엘리베이터 옆 계단으로만 올라갈 수 있어. 음악실1, 음악실2, 옥상(잠김) 별빛마루, 밴드실, 미술실이 있어. 계단에서 올라오자마자 음악실1이 보이고 왼쪽으로 가면 큰 공간이 있고 거기에 음악실 2가 있어. 음악실 2 옆에는 옥상 문이 있는데 안전상으로 잠겨있어. 계단기준 오른쪽으로 가면 큰 별빛마루가 있어 별빛마루 끝쪽 문으로 가면 밴드실이 있어. 문을 열고 반대편으로 나와서 오른쪽 끝으로 가면 미술실이 있어.
마지막으로 지하1층은 봉쇄됐어.
`;
